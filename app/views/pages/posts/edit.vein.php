		...
		<div class="body">
			<form action="/posts/{$post->id}" method="post">
				<div class="form-group">
					...
					<input type="text" name="title" class="form-control" placeholder="This is my title" required value="{$post->title}">
				</div>
				<div class="form-group">
					<label id="body">Body</label>
					<textarea type="text" name="body" class="form-control" placeholder="This is my body" rows="7" required>{$post->body}</textarea>
				</div>
